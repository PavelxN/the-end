    ...
    public partial class Form3 : Form
    {
        ...
        public class Database
        {
            ...
            public void Update(ComboBox comboBox2, ComboBox comboBox3, ComboBox comboBox4, ComboBox comboBox1, TextBox textBox1)
            {
                ...
                string SQL_izm = "UPDATE query SET id_room=N'"+ comboBox2.SelectedValue.ToString() +"', id_employee=N'"+ comboBox3.SelectedValue.ToString() +"', id_items=N'"+ comboBox4.SelectedValue.ToString() +"', status =N'"+ comboBox1.Text +"', comment =N'"+ textBox1.Text +"' where id=" + id;
